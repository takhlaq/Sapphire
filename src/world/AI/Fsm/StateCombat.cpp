...
void AI::Fsm::StateCombat::onUpdate( Entity::GameObjectPtr& pEntity, uint64_t tickCount )
{
...
void AI::Fsm::StateCombat::onEnter( Entity::GameObjectPtr& pEntity )
{
}

void AI::Fsm::StateCombat::onExit( Entity::GameObjectPtr& pEntity )
{
  if( auto pBNpc = pEntity->getAsBNpc() )
  {
    auto& bnpc = *pBNpc;
